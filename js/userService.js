    ...
    fetch("https://reqres.in/api/users?page=" + page, {
        ...
        .then((response) => {
            if (response.status === 200) {
                let listUsers = `
                <button type="button" class="btn btn-outline-success" onclick="addUser()"><i class="fa-solid fa-user-plus"></i></i></button>
                <table class="table">
                    <thead>
                        <tr>
                            <th scope="col">#</th>
                    ...
                    <div class="card">
                        <div class="card-body">
                          ...
                          <div class="mb-3">
                            ...
                            <button class = "btn btn-success" type = "button" onclick="saveUser()"><i class="fa-solid fa-floppy-disk"></i> Save
                             </button>
                            </div>
                          </form>
                        </div>
        ...
        fetch("https://reqres.in/api/users", {
            ...
            .then((response) => {
                if (response.status === 201) {
                    ...
                    document.getElementById('info').innerHTML = '<h3>USer was register error !</h3>'
                }
